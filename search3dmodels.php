...
<input id="search" name="search" style="width: 70%;" type="text" placeholder="Categories (ie. vehicle)">
...
<br>
    ...
    <input type="checkbox" value="thumbnail" class="hidden" checked />
			...
			<button onclick="window.location.href = '3dmodels.php';">Back To All 3D Models</button>
			<br>
</ul>
