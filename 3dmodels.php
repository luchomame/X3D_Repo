...
<input id="search" name="search" type="text" 
	style="width: 70%;" placeholder="Categories (ie. vehicle)">
...
<b>Alphabetical</b>
	<li>
        <input type="radio" name="Alphabetical" value="Ascending" id="filter-Ascending" />
        <label for="filter-Ascending">Ascending</label>
    </li>
	<li>
        <input type="radio" name="Alphabetical" value="Descending" id="filter-Descending" />
